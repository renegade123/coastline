  function del2,f
    ...
    L[nx-1,*]=0
    L[*,ny-1]=0
;    L[0,0]=(f[2,0]+f[0,2]+2*f[0,0])/4-(f[1,0]+f[0,1])/2;вСио╫г
;    L[nx-1,0]=(f[nx-3,0]+f[nx-1,2]+2*f[nx-1,0])/4-(f[nx-2,0]+f[nx-1,1])/2;вСоб╫г
;    L[0,ny-1]=(f[0,ny-3]+f[2,ny-1]+2*f[0,ny-1])/4-(f[0,ny-2]+f[1,ny-1])/2;срио╫г
;    L[nx-1,ny-1]=(f[nx-3,ny-1]+f[nx-1,ny-3]+2*f[nx-1,ny-1])/4-(f[nx-2,ny-1]+f[nx-1,ny-2])/2;сроб╫г
;    for j=1,ny-2 do begin
